...
MinkLauncher Open does not operate a server, include analytics or advertising SDKs, create an account, or upload personal data.

The app stores its settings, to-dos, selected document-folder references, and five most recent plain-text queries locally on the device. Android cloud backup is disabled for the application.
